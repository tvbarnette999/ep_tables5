...
//*******************************************************************//
//Stupid way to determine user is on timeslider or editor page.      //
//Need a more reliable way to do this.                               //
//*******************************************************************//
	if (node.toString()[8] == "O"){
		...
		dtAttrs = dtAttrs || "";
		DatatablesRenderer.render(context, node, dtAttrs);
